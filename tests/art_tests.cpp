...
TEST_SUITE("art") {
  ...
  TEST_CASE("delete value") {
    ...
    auto key0 = reinterpret_cast<const uint8_t *>("aa");
    auto int0 = 0;
    auto key1 = reinterpret_cast<const uint8_t *>("aaaa");
    auto int1 = 1;
    auto key2 = reinterpret_cast<const uint8_t *>("aaaaaaa");
    auto int2 = 2;
    auto key3 = reinterpret_cast<const uint8_t *>("aaaaaaaaaa");
    auto int3 = 3;
    auto key4 = reinterpret_cast<const uint8_t *>("aaaaaaaba");
    auto int4 = 4;
    auto key5 = reinterpret_cast<const uint8_t *>("aaaabaa");
    auto int5 = 5;
    auto key6 = reinterpret_cast<const uint8_t *>("aaaabaaaaa");
    auto int6 = 6;
    auto key7 = reinterpret_cast<const uint8_t *>("aaaaaaaaaaa");
    auto int7 = 7;
    auto key8 = reinterpret_cast<const uint8_t *>("aaaaaaaaaab");
    auto int8 = 8;
    auto key9 = reinterpret_cast<const uint8_t *>("aaaaaaaaaac");
    auto int9 = 9;
    ...
    SUBCASE("delete non existing value") {
      REQUIRE(m.del(reinterpret_cast<const uint8_t *>("aaaaa")) == nullptr);
      REQUIRE(m.del(reinterpret_cast<const uint8_t *>("aaaaaa")) == nullptr);
      REQUIRE(m.del(reinterpret_cast<const uint8_t *>("aaaab")) == nullptr);
      REQUIRE(m.del(reinterpret_cast<const uint8_t *>("aaaaba")) == nullptr);
  ...
  TEST_CASE("monte carlo delete") {
    ...
    for (int i = 0; i < 1000000; ++i) {
      ...
      auto v = new int();
      *v = i;
      REQUIRE(m.set(reinterpret_cast<const uint8_t *>(k.c_str()), v) == nullptr);
    }
    mt19937_64 rng2(0);
    for (int i = 0; i < 1000000; ++i) {
      ...
      REQUIRE(m.get(reinterpret_cast<const uint8_t *>(k.c_str())) == nullptr);
